...
class DataReader(object):
    ...
    def __init__(self, input_dir, output_dir, norm_dir, w=19, u=9, name=None, st=0):
        ...
        self._input_file_list = sorted(glob.glob(input_dir+r'\*.bin'))[st:]
        self._input_spec_list = sorted(glob.glob(input_dir+r'\*.txt'))[st:]
        self._output_file_list = sorted(glob.glob(output_dir+r'\*.bin'))[st:]
        ...
        norm_param = sio.loadmat(self._norm_dir+r'\global_normalize_factor.mat')
